; Inno Setup Script for NM Helper Flutter Application
; Created for building Windows installer via GitHub Actions
; Put this in `windows/installer/`

#define MyAppName "NM Helper"
#define MyAppVersion GetEnv("APP_VERSION")
#define MyAppPublisher "Kittipos Sirivongrungson"
#define MyAppURL "https://github.com/Lightbridge-KS/nm_helper"
#define MyAppExeName "nm_helper.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
AppId={{F7C3B4A2-8E9D-4F6A-A1B7-2C5D8E9F0130}
AppName={#MyAppName}
...
OutputBaseFilename=NM-Helper-Setup
Compression=lzma
